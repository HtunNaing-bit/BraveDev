...
export function PortfolioPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-20 transition-colors duration-300">
      ...
      <div className="absolute top-[600px] right-[15%] w-80 h-80 bg-black/5 dark:bg-white/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="container mx-auto px-6 lg:px-16">
          <div className="max-w-[1400px] mx-auto">
            ...
            <div className="mb-20">
              ...
              >
                Explore our completed projects showcasing mobile apps, web platforms, POS systems, and custom software solutions.
              </motion.p>
            </div>
          </div>
        </div>
